    ...
    public void run() {
        try {
            ...
            do {
                ...
                String filter = "(chuvoso|frio|quente)";
                String fixedInput = clientMessage.replaceAll(filter, "**");
                ...
                serverMessage = "[" + userName + "]: " + fixedInput;
                server.broadcast(serverMessage, this);
                
                OutputStream outputFile = new FileOutputStream("logs.txt"); 
		        System.out.println(outputFile);
                Writer escrever = new OutputStreamWriter(outputFile); 
                System.out.println(escrever);
                escrever.write(serverMessage);
